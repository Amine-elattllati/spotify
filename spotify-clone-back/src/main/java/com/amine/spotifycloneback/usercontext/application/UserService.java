package com.amine.spotifycloneback.usercontext.application;

import com.amine.spotifycloneback.usercontext.ReadUserDTO;
import com.amine.spotifycloneback.usercontext.domain.User;
import com.amine.spotifycloneback.usercontext.mapper.UserMapper;
import com.amine.spotifycloneback.usercontext.repository.UserRepository;
...
public class UserService {
    ...
    public void syncWithIdp(OAuth2User oAuth2User) {
        ...
        User user = map0auth2AttributesToUser(attributes);
